...
test('search learning ops completion recommendation outcome recommendation outcome recommendation recommendations classify next actions', () => {
            ...
            topReadyReview: [
                {
                    id: 'outcome-1',
                    outcomeId: 'hoodie-review',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Review',
                    action: 'review_now',
                    context: 'ctx:review',
                    createdAt: '2026-03-12T10:30:00.000Z',
                    queries: ['운동용 후드'],
            ...
            topNeedsAttention: [
                {
                    id: 'outcome-2',
                    outcomeId: 'pants-retrain',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Retrain',
                    action: 'retrain_now',
                    context: 'ctx:retrain',
                    createdAt: '2026-03-12T10:29:00.000Z',
                    queries: ['트레이닝 팬츠'],
            ...
            topAwaitingSamples: [
                {
                    id: 'outcome-3',
                    outcomeId: 'runner-awaiting',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Samples',
                    action: 'collect_samples',
                    context: 'ctx:awaiting',
                    createdAt: '2026-03-12T10:28:00.000Z',
                    queries: ['러닝 자켓'],
            ...
            topValidated: [
                {
                    id: 'outcome-4',
                    outcomeId: 'validated',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Observe',
                    action: 'observe',
                    context: 'ctx:validated',
                    createdAt: '2026-03-12T10:27:00.000Z',
                    queries: ['와이드 팬츠'],
...
test('search learning ops completion recommendation outcome recommendation outcome recommendation recommendation queue prioritizes execute and review items', () => {
    const queue =
            ...
            topReviewNow: [
                {
                    id: 'reco-1',
                    outcomeId: 'hoodie-review',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Review',
                    description: 'review',
                    reason: 'review reason',
                    action: 'review_now',
                    actionLabel: 'review 즉시 승인',
            ...
            topRetrainNow: [
                {
                    id: 'reco-2',
                    outcomeId: 'pants-retrain',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Retrain',
                    description: 'retrain',
                    reason: 'retrain reason',
                    action: 'retrain_now',
                    actionLabel: '재학습 AI 제안',
            ...
            topCollectSamples: [
                {
                    id: 'reco-3',
                    outcomeId: 'runner-awaiting',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Samples',
                    description: 'samples',
                    reason: 'samples reason',
                    action: 'collect_samples',
                    actionLabel: '표본 수집 대상 선택',
            ...
            topObserve: [
                {
                    id: 'reco-4',
                    outcomeId: 'validated',
                    title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Observe',
                    description: 'observe',
                    reason: 'observe reason',
                    action: 'observe',
                    actionLabel: '개선 query 선택',
...
test('search learning ops completion recommendation outcome recommendation outcome recommendation recommendation recommendations classify next actions', () => {
    const recommendations =
        buildSearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendationRecommendationRecommendations(
            {
                ...
                topReadyReview: [
                    {
                        id: 'outcome-ready',
                        outcomeId: 'hoodie-review',
                        title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Recommendation Review',
                        action: 'review_now',
                        context: 'ctx:ready',
                        createdAt: '2026-03-12T10:50:00.000Z',
                        queries: ['운동용 후드'],
                ...
                topNeedsAttention: [
                    {
                        id: 'outcome-retrain',
                        outcomeId: 'pants-retrain',
                        title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Recommendation Retrain',
                        action: 'retrain_now',
                        context: 'ctx:retrain',
                        createdAt: '2026-03-12T10:49:00.000Z',
                        queries: ['트레이닝 팬츠'],
                ...
                topAwaitingSamples: [
                    {
                        id: 'outcome-awaiting',
                        outcomeId: 'runner-awaiting',
                        title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Recommendation Samples',
                        action: 'observe',
                        context: 'ctx:awaiting',
                        createdAt: '2026-03-12T10:48:00.000Z',
                        queries: ['러닝 자켓'],
                ...
                topValidated: [
                    {
                        id: 'outcome-validated',
                        outcomeId: 'wide-validated',
                        title: 'Completion Outcome Recommendation Outcome Recommendation Outcome Recommendation Recommendation Observe',
                        action: 'observe',
                        context: 'ctx:validated',
                        createdAt: '2026-03-12T10:47:00.000Z',
                        queries: ['와이드 팬츠'],
