import type {
    ...
    SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeStatus,
    SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeSummary,
} from './searchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomes.ts';

export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendationAction =
    | 'review_now'
    | 'retrain_now'
    | 'collect_samples'
    | 'observe';

export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation = {
    id: string;
    outcomeId: string;
    title: string;
    description: string;
    ...
    outcomeStatus: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeStatus;
    createdAt: string;
    entryIds: string[];
    queries: string[];
...
export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendationSummary = {
    total: number;
    reviewNow: number;
    retrainNow: number;
    ...
    critical: number;
    highPriority: number;
    topReviewNow: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation[];
    topRetrainNow: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation[];
    topCollectSamples: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation[];
    topObserve: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation[];
};

function classifyOutcome(
    outcome: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcome
): Pick<
    ...
    switch (outcome.status) {
        case 'ready_review':
            return {
                ...
                reason: `${outcome.readyReviewCount}개의 query가 completion recommendation outcome recommendation outcome 단계에서 review 대기 상태입니다.`,
            };
...
function sortRecommendations(
    items: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation[]
): SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendation[] {
...
function toRecommendation(
    ...
    return {
        id: `completion_recommendation_outcome_recommendation_outcome_recommendation:${outcome.id}`,
...
export function buildSearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeRecommendations(
    outcomes: SearchLearningOpsCompletionRecommendationOutcomeRecommendationOutcomeSummary
