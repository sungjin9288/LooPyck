import type {
    ...
    SearchLearningOpsCompletionRecommendationOutcomeRecommendationAction,
    SearchLearningOpsCompletionRecommendationOutcomeRecommendationSummary,
} from './searchLearningOpsCompletionRecommendationOutcomeRecommendations.ts';

export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueState =
    | 'execute_now'
    | 'needs_review'
    | 'sample_collection'
    | 'observe';

export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem = {
    id: string;
    recommendationId: string;
    title: string;
    description: string;
    reason: string;
    queueState: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueState;
    action: SearchLearningOpsCompletionRecommendationOutcomeRecommendationAction;
    actionLabel: string;
    priority: 'critical' | 'high' | 'medium' | 'low';
    outcomeStatus: SearchLearningOpsCompletionRecommendationOutcomeRecommendation['outcomeStatus'];
    createdAt: string;
    entryIds: string[];
    queries: string[];
...
export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueSummary = {
    total: number;
    executeNow: number;
    needsReview: number;
    ...
    observe: number;
    urgent: number;
    topExecuteNow: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem[];
    topNeedsReview: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem[];
    topSampleCollection: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem[];
    topObserve: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem[];
};

function resolveQueueState(
    action: SearchLearningOpsCompletionRecommendationOutcomeRecommendationAction
): SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueState {
    switch (action) {
        case 'retrain_now':
            return 'execute_now';
        case 'review_now':
...
function stateWeight(state: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueState): number {
    switch (state) {
        case 'execute_now':
            return 4;
        case 'needs_review':
...
function priorityWeight(priority: SearchLearningOpsCompletionRecommendationOutcomeRecommendation['priority']): number {
    switch (priority) {
        case 'critical':
            return 4;
        case 'high':
...
function toQueueItem(
    ...
    return {
        id: `completion_recommendation_outcome_recommendation_queue:${recommendation.id}`,
...
function sortQueue(
    items: SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem[]
): SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueItem[] {
...
export function buildSearchLearningOpsCompletionRecommendationOutcomeRecommendationQueue(
    summary: SearchLearningOpsCompletionRecommendationOutcomeRecommendationSummary
): SearchLearningOpsCompletionRecommendationOutcomeRecommendationQueueSummary {
