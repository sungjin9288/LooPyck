import type {
    SearchLearningOpsCompletionRecommendationOutcome,
    SearchLearningOpsCompletionRecommendationOutcomeStatus,
    SearchLearningOpsCompletionRecommendationOutcomeSummary,
} from './searchLearningOpsCompletionRecommendationOutcomes.ts';

export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationAction =
    | 'review_now'
    | 'retrain_now'
    | 'collect_samples'
    | 'observe';

export type SearchLearningOpsCompletionRecommendationOutcomeRecommendation = {
    id: string;
    outcomeId: string;
    title: string;
    description: string;
    ...
    outcomeStatus: SearchLearningOpsCompletionRecommendationOutcomeStatus;
    createdAt: string;
    entryIds: string[];
    queries: string[];
...
export type SearchLearningOpsCompletionRecommendationOutcomeRecommendationSummary = {
    total: number;
    reviewNow: number;
    retrainNow: number;
    ...
    critical: number;
    highPriority: number;
    topReviewNow: SearchLearningOpsCompletionRecommendationOutcomeRecommendation[];
    topRetrainNow: SearchLearningOpsCompletionRecommendationOutcomeRecommendation[];
    topCollectSamples: SearchLearningOpsCompletionRecommendationOutcomeRecommendation[];
    topObserve: SearchLearningOpsCompletionRecommendationOutcomeRecommendation[];
};

function classifyOutcome(
    outcome: SearchLearningOpsCompletionRecommendationOutcome
): Pick<
    ...
    switch (outcome.status) {
        case 'ready_review':
            return {
                ...
                reason: `${outcome.readyReviewCount}개의 review 대기 query가 completion recommendation outcome에서 준비됐습니다.`,
            };
...
function sortRecommendations(
    items: SearchLearningOpsCompletionRecommendationOutcomeRecommendation[]
): SearchLearningOpsCompletionRecommendationOutcomeRecommendation[] {
...
function toRecommendation(
    ...
    return {
        id: `completion_recommendation_outcome_recommendation:${outcome.id}`,
...
export function buildSearchLearningOpsCompletionRecommendationOutcomeRecommendations(
    outcomes: SearchLearningOpsCompletionRecommendationOutcomeSummary
