...
**정의**: 두 가지 방식의 데이터 추출 결과를 비교하는 설계 개념. 현재 runtime에는 별도 Cross-Checker module이 없다.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Cross-Checker → 일치 여부 확인
```

**장점**: 단일 방식의 오탐지를 서로 검사할 수 있음. 정확도는 별도 labeled dataset 평가가 필요함.
